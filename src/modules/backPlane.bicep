...
resource hostPool 'Microsoft.DesktopVirtualization/hostPools@2023-09-05' = if (newBuild) {
  name: hostPoolName
  location: location
  properties: {
...
resource applicationGroup 'Microsoft.DesktopVirtualization/applicationGroups@2023-09-05' = if (newBuild) {
  name: appGroupName
  location: location
  properties: {
...
resource workspace 'Microsoft.DesktopVirtualization/workspaces@2023-09-05' = if (newBuild) {
  name: workspaceName
